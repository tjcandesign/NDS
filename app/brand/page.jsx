  ...
  return (
    <div style={{ background: "#fafaf9", color: "#1c1917", minHeight: "100vh", fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ position: "relative", height: "60vh", minHeight: 400, overflow: "hidden" }}>
        ...
        />
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to bottom, rgba(54,68,84,0.6) 0%, rgba(54,68,84,0.8) 60%, #364454 100%)" }} />
        ...
        <Section id="typestyles" label="04 \u2014 Type Styles">
          <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
            {BRAND.typeStyles.map((style, i) => (
              <div key={i} style={{ padding: "48px 40px", border: "1px solid #e7e5e4" }}>
