  ...
  return (
    <>
      ...
      {project.coverImage && (
        <div className="relative w-full h-[88vh] min-h-[560px] bg-stone-200 overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col justify-between">
            <Link
              href="/portfolio"
              className="pt-24 px-6 md:px-6 text-xs tracking-widest uppercase text-white/60 hover:text-white transition-colors w-full"
            >
              ← Portfolio
            </Link>

            <div className="pb-10 px-6 md:px-6 w-full">
      ...
      <section className="pb-16">
        <div className="grid grid-cols-1 md:grid-cols-6 gap-3 md:gap-0 md:px-6 md:items-start max-w-9xl mx-auto">
          ...
          {/* Right: Sidebar */}
          <aside className="px-3 md:px-0 md:sticky md:top-12 md:mt-12 md:col-span-1">
